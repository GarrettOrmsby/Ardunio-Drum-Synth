...
void playKick() {
  clearSounds();
  switch (preset) {
    case 0: queuePitchDrop(698.46, 690, 1); break;
    ...
    case 9: queuePitchDrop(100, 100, 5); break;
...
void playSnare() {
  ...
  switch (preset) {
    case 0: queuePitchDrop(1046.5, 1039, 1); break; //
...
void playPad1() {
  clearSounds();
  switch (preset) {
    case 0: queuePitchDrop(1479.98, 1470, 1); break;
...
void playPad2() {
  clearSounds();
  switch (preset) {
    case 0: queuePitchDrop(1661.22, 1652, 1); break;
...
void playPad3() {
  clearSounds();
  switch (preset) {
    case 0: queuePitchDrop(1975.533, 1967, 1); break;
